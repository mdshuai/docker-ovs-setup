...
ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=10,dl_dst=00:00:00:00:00:01,actions=output:1"
ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=20,dl_dst=00:00:00:00:00:02,actions=output:2"
ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=10,dl_dst=00:00:00:00:00:03,actions=set_field:10->tun_id,output:10"
ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=20,dl_dst=00:00:00:00:00:04,actions=set_field:20->tun_id,output:10"

#ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=10,arp,nw_dst=10.0.0.1,actions=output:1"
...
#ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=20,arp,nw_dst=10.0.0.2,actions=output:2"
...
#ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=10,arp,nw_dst=10.0.0.3,actions=output:10"
...
#ovs-ofctl add-flow -O OpenFlow13 br0 "table=1,priority=200,tun_id=20,arp,nw_dst=10.0.0.4,actions=output:10"
